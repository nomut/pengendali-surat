...
// Fungsi unggah file baru (SAMA PERSIS DENGAN FILE PATOKAN ANDA)
...
const submit = async () => {
    try {
        ...
        form.post(route('surat-tugas.update', props.surat.id), {
            onSuccess: () => {
                toast.add({ severity: 'success', summary: 'Berhasil', detail: 'Data surat tugas telah diperbarui.', life: 3000 });
            },
        });
    } catch (error) {
        console.error(error);
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <InertiaHead :title="`Edit Surat Tugas: ${surat.nomor_surat}`" />
                        ...
                        <template #content>
                            <div class="flex flex-col gap-6">
                                ...
                                <div>
                                    ...
                                    <Textarea id="tujuan" v-model="form.tujuan" rows="3" class="w-full" :invalid="!!form.errors.tujuan" />
                                        ...
                                        >
                                            <template #empty>
                                                <div class="flex items-center justify-center flex-col">
                                                    <UploadCloud class="w-16 h-16 text-gray-400" />
                                                    <p class="mt-6 mb-0">Seret dan lepas file ke sini.</p>
                                                </div>
                                            </template>
                                        </FileUpload>
                    ...
                    <Card class="h-full">
                        ...
                        <template #footer>
                            <div class="flex flex-row gap-3 pt-4">
                                <Button type="submit" label="Simpan" :loading="form.processing || isUploading">
